...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // Call image generation API (OpenAI-compatible)
    ...
    // Track token usage (extracts from response metadata)
    ...
    // Fire-and-forget telemetry — logs style, ratio, cfg, steps for adaptive defaults
